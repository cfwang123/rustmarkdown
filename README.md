...
- Preview fold by heading; fenced code over 10 lines starts folded (not Mermaid); click the gray footer or double-click the code body to toggle (`... <CR> collapse` / `expand`, aligned with mdview); code boxes stretch to content width
